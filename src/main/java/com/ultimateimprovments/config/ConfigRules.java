...
final class ConfigRules {
    ...
    static final List<Rule> ALL = List.of(
            ...
            integer("features.block_collapse.save_interval_seconds", 1, 86400),
            bool("features.block_collapse.lore_enabled"),
            integer("features.block_collapse.lore_interval_ticks", 1, 72000),
            bool("features.block_collapse.log_block_actions"),
            dbl("features.block_collapse.default_heaviness", 0, 1000),
            bool("features.block_collapse.scan.enabled"),
            integer("features.block_collapse.scan.delay_seconds", 0, 3600),
            integer("features.block_collapse.scan.interval_seconds", 1, 3600),
            integer("features.block_collapse.scan.area", 1, 64),
            dbl("features.block_collapse.scan.max_mspt", 1, 1000),
            ...
            bool("features.exp_bottle_upgrade.enabled"),
            integer("features.exp_bottle_upgrade.max_multiplier", 1, 1000000, "Макс. множитель пузырька опыта"),
            integer("features.exp_bottle_upgrade.anvil_cost_amount", 0, 100, "Стоимость крафта в наковальне (уровни)"),
            notBlank("features.exp_bottle_upgrade.item_name", 200),
            stringList("features.exp_bottle_upgrade.item_lore"),
