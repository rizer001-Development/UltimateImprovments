...
/**
 * EnchantmentSyncListener — detects chestplates carrying the Flight enchantment and
 * keeps the PDC mirror ({@code ui:flight_level}) in sync with the real enchantment.
 * <p>
...
public class EnchantmentSyncListener implements Listener {
    ...
    public static void register(Main plugin) {
        ...
        ConsoleLogger.info("[Flight] Sync listener registered (PDC failsafe, scan every "
