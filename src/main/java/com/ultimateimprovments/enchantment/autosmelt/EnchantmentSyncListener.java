...
/**
 * EnchantmentSyncListener — detects tools carrying the AutoSmelt enchantment and
 * keeps the PDC mirror ({@code ui:autosmelt_level}) in sync with the real enchantment.
 * <p>
...
public class EnchantmentSyncListener implements Listener {
    ...
    public static void register(Main plugin) {
        ...
        ConsoleLogger.info("[AutoSmelt] Sync listener registered (PDC failsafe, scan every "
