...
/**
 * EnchantmentSyncListener — detects weapons carrying the Attack AoE enchantment and
 * keeps the PDC mirror ({@code ui:attack_aoe_level}) in sync with the real enchantment.
 * <p>
