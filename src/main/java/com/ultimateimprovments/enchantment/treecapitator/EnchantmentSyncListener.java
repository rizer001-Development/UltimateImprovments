...
/**
 * EnchantmentSyncListener — detects tools carrying the TreeCapitator enchantment and
 * keeps the PDC mirror ({@code ui:treecapitator_level}) in sync with the real enchantment.
 * <p>
