 ...
 * ALSO stores the level (always 1) in the {@code ui:item_stealing_level} PDC key — a
 * backup mirror:
 * <ul>
 ...
 * </ul>
 * <p>
 * Effect: when a player hooks another PLAYER with the enchanted fishing rod and reels
 * in, the victim is NOT pulled — instead the item he holds in his hand flies to the
 * fisher (main hand first, offhand as fallback). If the victim holds nothing, the
...
public final class Enchantment {
    ...
    /**
     * Sets the Item Stealing enchantment on the given item.
