...
/**
 * EnchantmentSyncListener — detects fishing rods carrying the Item Stealing
 * enchantment and keeps the PDC mirror ({@code ui:item_stealing_level}) in sync
 * with the real enchantment.
 * <p>
