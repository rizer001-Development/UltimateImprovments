...
/**
 * EnchantmentSyncListener — detects tools carrying the Container Stealing enchantment and
 * keeps the PDC mirror ({@code ui:container_stealing_level}) in sync with the real enchantment.
 * <p>
